...
int c;
int f=400;
int f11=350;//level 1 score
int f12=350;//level 2 score
int f13=450;//level 3 score
int f14=550;//level 4 score
int f15=450;//level 5 score
int f16=600;
int z=0;
int maximumscore;
int flag=0;
...
int maximum;
int highest;
fp1=fopen("highscoreinagame.txt","r");
while(!feof(fp1)){
    fscanf(fp1,"%d\n",&highest);
...
fclose(fp1);
fp1=fopen("highscoreinagame.txt","w");
fprintf(fp1,"%d\n",maximum);
fclose(fp1);
...
void iDraw()
{
 ...
 itoa(tsc2,tc2,10);
        iText(150,250,"total score",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(250,250,tc1,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(150,380,"high score",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(250,380,tc2,GLUT_BITMAP_TIMES_ROMAN_24);
...
if(ball_x4!=200 && ball_y4!=300 && flag4==1){
  ...
  if(ball_x6==130 && ball_y6==230 && flag6==1)
    ...
    if (flag6==2){
        ...
        iText(250,250,tc1,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(70,90,"YOUR SCORE",GLUT_BITMAP_TIMES_ROMAN_24);
        iText(250,90,sc6,GLUT_BITMAP_TIMES_ROMAN_24);
        iText(100,200,"press 'n' for new level",GLUT_BITMAP_TIMES_ROMAN_24);
...
//these are starting and finishing line
    ...
    iText( 105,225 , "START",
       ...
       iClear();
     //   PlaySound("D:\\test.wav", NULL, SND_ASYNC | SND_LOOP);
...
if((((ball_x3-10) <150 )||((ball_x3-10) >150 )||(ball_y3<165)||(ball_y3>275))&&
    ...
    if(key == GLUT_KEY_UP)
    {
        ...
        if(
           ...
           &&
           (((ball_y1+10) <150 )||((ball_y1+10) >150 )||(ball_x1<205)||(ball_x1>215))&&(flag1==1) )
            {
            ball_y1=ball_y1+10;
            f11--;
            score1(f11);
    ...
    if(key == GLUT_KEY_RIGHT)
    {
          ...
          )
        {
            ...
            if((((ball_x1+10) <160 )||((ball_x1+10) >160 )||(ball_y1<155)||(ball_y1>255))&&
               ...
               (((ball_x1-10) <200 )||((ball_x1-10) >200 )||(ball_y1<145)||(ball_y1>155))&&
          (((ball_x1-10) <200 )||((ball_x1-10) >200 )||(ball_y1<145)||(ball_y1>155))&&(flag1==1)
